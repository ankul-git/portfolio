...
const projects = [
  {
    ...
    description: "Designed and deployed a cloud-native reliability platform for monitoring infrastructure health. Collected and analyzed metrics using Prometheus to detect resource saturation and system anomalies.",
  },

  {
    ...
    image: "",
    description: "Led observability operations by building comprehensive API monitoring with Prometheus & Grafana. Designed proactive alerting systems and dashboards for advanced vendor tracking to ensure strict SLA compliance and service reliability.",
  },
  {
    ...
    image: "",
    description: "Managed end-to-end deployment workflows across isolated staging and production clusters. Unified environment configuration and implemented robust automated scaling policies to efficiently handle demanding, high-traffic user workloads.",
  },
  {
    ...
    image: "",
    description: "Engineered completely automated CI/CD pipelines using GitHub Actions and GitOps workflows. Eliminated configuration drift while consistently enforcing rigorous automated testing and seamless zero-downtime production rollouts.",
  },
  {
